In the following, we run our algorithm Algorithm 3 GuessingBivar(𝒖) on the same
...
and we compute, as in the iterative version, the quotient matrix $Q_0$ and the
...
Gröbner basis of $I(u)$. 

## `GuessingBivar`

The following description follows the iterative version of the algorithm, we
have described in example_iterative.md. 
